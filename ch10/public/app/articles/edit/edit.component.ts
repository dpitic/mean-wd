 ...
 * Edit subcomponent will handle editing existing articles.
 */
...
export class EditComponent {
    ...
    update() {
        this._articlesService
            .update(this.article)
            .subscribe(savedArticle => this._router.navigate(['/articles',
                savedArticle._id]), error => this.errorMessage = error);
    }
}